...
export const metadata: Metadata = {
  ...
  description:
    "HC Workforce Solutions LLC — Armenia-based staffing and workforce solutions partner now serving European markets. Qualified personnel for hospitality, healthcare, retail, corporate, industrial, VIP household, and more.",
  keywords: [
    "Workforce Solutions Armenia",
    "Staffing Agency Armenia",
    "Recruitment Agency Armenia",
    "International Staffing Agency",
    "Staffing Agency Europe",
    "Armenian Staffing Europe",
    "Corporate Staffing Armenia",
    "Hotel Staffing Armenia",
    "Healthcare Staffing Armenia",
    "Housekeeping Staffing Armenia",
    "VIP Household Staffing",
  ...
  openGraph: {
    ...
    description:
      "Armenia-based staffing solutions now serving European markets. Qualified personnel for hospitality, healthcare, retail, corporate, VIP household, and more.",
    images: [
      {

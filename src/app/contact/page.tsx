            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="card border border-gray-100">
                ...
                <div className="flex gap-3">
                  ...
                  <a href="https://linkedin.com/company/hcworkforcesolutions" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-brand-light-gray rounded-lg flex items-center justify-center hover:bg-brand-gold/20 transition-colors" aria-label="LinkedIn">
